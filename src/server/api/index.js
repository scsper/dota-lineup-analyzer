...
module.exports = {
     ...
     */
    getLeagueMatches: function(leagueId, startingMatchId, matchesRequested) {
        var url = MATCH_HISTORY_URL + "&league_id=" + leagueId;
     ...
     * @return {Promise} Unresolved promise that will contain the data for this API
     */
    getPlayerMatches: function(playerId, startingMatchId, matchesRequested) {
        var url = MATCH_HISTORY_URL + "&account_id=" + playerId;
     ...
     */
    getPlayerStats: function(leagueId, accountId) {
